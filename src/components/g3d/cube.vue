...
export default {
  ...
  mounted() {
    var loader = (function() {
      ...
      function loadBlob(url, callback) {
        request(url, callback, "arraybuffer");
      }
      ...
      return {
        ...
        loadImage: loadImage,
        loadBlob: loadBlob,
        loadImageQueue: loadImageQueue,
        loadTextQueue: loadTextQueue
      };
    })();
    this.init();
  },
  methods: {
    ...
    main(canvas) {
      ...
      const lFolder = gui.addFolder("lights");
      const l1Folder = lFolder.addFolder("ambient light");
      l1Folder.add(light1, "intensity", 0, 1);
      l1Folder.add(light1.color, "r", 0, 255);
      l1Folder.add(light1.color, "g", 0, 255);
      l1Folder.add(light1.color, "b", 0, 255);
      const l2Folder = lFolder.addFolder("directional light");
      l2Folder.add(light2, "intensity", 0, 1);
      l2Folder.add(light2.color, "r", 0, 255);
      l2Folder.add(light2.color, "g", 0, 255);
      l2Folder.add(light2.color, "b", 0, 255);

      const mFolder = gui.addFolder("phong material");
      const abFolder = mFolder.addFolder("ambient");
      abFolder.add(pMtl.ambientColor, "r", 0, 255);
      abFolder.add(pMtl.ambientColor, "g", 0, 255);
      abFolder.add(pMtl.ambientColor, "b", 0, 255);
      const dfFolder = mFolder.addFolder("diffuse");
      dfFolder.add(pMtl.diffuseColor, "r", 0, 255);
      dfFolder.add(pMtl.diffuseColor, "g", 0, 255);
      dfFolder.add(pMtl.diffuseColor, "b", 0, 255);
      const spFolder = mFolder.addFolder("specular");
      spFolder.add(pMtl.specularColor, "r", 0, 255);
      spFolder.add(pMtl.specularColor, "g", 0, 255);
      spFolder.add(pMtl.specularColor, "b", 0, 255);
      mFolder.add(cube.materials.default, "glossiness", 0, 10);
